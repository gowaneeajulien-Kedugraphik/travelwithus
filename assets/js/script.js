...
class CookieBanner {
  constructor() {
    ...
    this.cookieName = 'travel_with_us_cookies_consent';
    this.init();
  }
  ...
  acceptCookies() {
    ...
    this.showNotification('✅ Préférences enregistrées - Cookies acceptés', 'success');
  }
  ...
  declineCookies() {
    ...
    this.showNotification('✅ Préférences enregistrées - Cookies refusés', 'success');
  }
...
// Ajouter l'initialisation de CookieBanner dans le DOMContentLoaded
document.addEventListener('DOMContentLoaded', () => {
  console.log('%c🏝️ TRAVEL WITH US', 'font-size: 24px; font-weight: bold; color: #28b8bd;');
  console.log('%c✨ Version Complète avec Destinations & Activités', 'font-size: 14px; color: #9FC8B6;');
  console.log('%c📞 WhatsApp: +230 5512 2352', 'font-size: 12px; color: #666;');
  ...
  new LazyLoader();
  new PerformanceMonitor();
  new CookieBanner();  // ← AJOUTEZ CETTE LIGNE

  console.log('✅ Tous les modules initialisés');
  console.log('🌍 Langues: FR, EN, DE');
  console.log('🍪 Bannière cookies activée');
  console.log('🎯 Nouvelles sections: Destinations + Activités + À propos enrichi\n');
});